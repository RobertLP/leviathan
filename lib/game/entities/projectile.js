...
.defines(function() {
  EntityProjectile = ig.Entity.extend({
    ...
    animSheet: new ig.AnimationSheet( 'media/projectile.png', 8, 3 ), // location of the picture for the animation, and the picture size (each frame).
    ...
    setAngle: function() {
      ...
      var AngleY = (this.pos.y + 250) - (300 * Math.cosAngle);
      return {x: AngleX, y: AngleY, sin: Math.sinAngle, cos: Math.cosAngle};
      ig.log(this.AngleX);
      ig.log(this.AngleY);
    },

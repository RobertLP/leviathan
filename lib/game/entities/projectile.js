...
.defines(function() {
  EntityProjectile = ig.Entity.extend({
    ...
    adjustProjectileAngle: function() {
     Character == this.
     var angle = this.angleTo(Entitycrosshair) //Return the angle from this entity's center to the other entity's center.
        ig.log(this.angle);
    }
  });
});
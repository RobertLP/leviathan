...
.defines(function() {
  EntityProjectile = ig.Entity.extend({
    ...
    animSheet: new ig.AnimationSheet( 'media/flame.gif', 16, 5 ), // location of the picture for the animation, and the picture size (each frame).
    ...
    setAngle: function() {
      if (this.flip) {
        this.anims.idle.angle = this.angle - Math.PI;
      } else {
